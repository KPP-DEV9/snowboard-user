...
## 5. Next.js 16 App Router & Performance Standards

- **CRITICAL DOCS RULE:** ALWAYS read the relevant doc in `node_modules/next/dist/docs/` before writing Next.js code. Your training data is outdated; the local package docs are the absolute source of truth.
...
- **Data Fetching & Routing:**
  - Support Next.js 16 async dynamic APIs: Await `params` and `searchParams` before validation/consumption.
